...
/// Retourne l'heure UTC actuelle (0-23)
pub fn now_hour() -> u32 {
    let ts = now_timestamp() as u64;
    ((ts / 3600) % 24) as u32
}

/// Convertit un timestamp Unix en date lisible: "YYYY-MM-DD HH:MM:SS UTC"
...
/// Convertit un timestamp Unix en date courte: "YYYY-MM-DD HH:MM UTC"
